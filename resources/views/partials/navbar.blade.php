        ...
        <nav class="navbar navbar-light navbar-expand-lg py-4">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="{{ route('event') }}" class="nav-item nav-link {{ request()->routeIs('event') ? 'active' : '' }}">Events</a>
                    <a href="{{ route('menu') }}" class="nav-item nav-link {{ request()->routeIs('menu') ? 'active' : '' }}">Menu</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle {{ request()->routeIs(['book', 'blog', 'team', 'testimonial']) ? 'active' : '' }}" data-bs-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu bg-light">
                            <a href="{{ route('book') }}" class="dropdown-item {{ request()->routeIs('book') ? 'active' : '' }}">Booking</a>
                ...
                <a href="{{ route('book') }}" class="btn btn-primary py-2 px-4 d-none d-xl-inline-block rounded-pill">Booking Now</a>
            </div>
        </nav>
    </div>
</div>
